...
<body>
  ...
  <div class="content-wrapper">
    ...
    <tbody>
        ...
        ?>
            <td><a href="dosen/view?id=<?=$row->nidn;?>"> View |</a><a href="dosen/edit?id=<?=$row->nidn;?>"> Edit |</a><a href="dosen/delete?id=<?=$row->nidn;?>" onclick='if(!confirm("Anda Yakin Ingin Menghapus Data Dosen Ini?")) {return false}'>Delete</a></td></tr>
        <?php
            $nomor++;
            }
        ?>
